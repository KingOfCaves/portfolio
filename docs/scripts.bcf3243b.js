  ...
  var data = {
    ...
    frontend: {
      ...
      projects: [{
        ...
        desc: "Reacreating Albion Sword's website into a React.js powered single page application. The app takes the original and applies multiple programmatic and design changes that improve the overall user experience. Uses React Router and React."
      }, {
        id: 'the-big-brown',
